<template>
  <div>
    <div class="card-link" v-for="(postlist) in postlists.data" :key="postlist.pnum" >
      <!-- if 에러 상관없음 -->
      <div class="blog-card">
          ...
          <div class="article-details">
            ...
            <div class="post-author">
              <div class="likes_and_comments">
                ...
                <img src="../../assets/postdetail/purplecomment.png" class="comments-image" alt="" style="cursor:pointer"> <span class="post-comments-num"> {{postlist.comments}} 개 </span>
              </div>
            </div>
          </div>
      </div> <!-- class="blog-card" -->
...
export default {
   ...
   computed: {
    postlists() {
      return this.$store.state.tenpostlist;
    },
    everypostlist() {
  ...
  created() {
    this.$store.dispatch('userFollowing', sessionStorage.getItem('user_num'));
  }
}
</script>
